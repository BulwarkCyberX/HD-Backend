...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^\d+$/, { message: 'Code must be 6 digits' }),
    __metadata("design:type", String)
], VerifyEmailDto.prototype, "code", void 0);
__decorate([
    (0, class_validator_1.ValidateIf)((o) => !o.email && !o.code),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(20, { message: 'Invalid verification link' }),
    __metadata("design:type", String)
